...
// .wrangler/tmp/bundle-1yQks7/checked-fetch.js
...
async function searchHotels(params, env2) {
  try {
    ...
    try {
      const hotelListResponse = await amadeus.get("/reference-data/locations/hotels/by-city", {
        cityCode,
...
// .wrangler/tmp/bundle-1yQks7/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-1yQks7/middleware-loader.entry.ts
