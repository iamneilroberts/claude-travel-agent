...
// .wrangler/tmp/bundle-tCrCj2/checked-fetch.js
...
async function searchHotels(params, env2) {
  try {
    ...
    if (params.ratings) {
      hotelListParams.ratings = params.ratings;
    }
    const hotelListResponse = await amadeus.get("/reference-data/locations/hotels/by-city", hotelListParams);
    ...
    try {
      const hotelOffers = await amadeus.get("/v3/shopping/hotel-offers", offerParams);
      return formatHotelResults(hotelOffers.data, params);
    } catch (offersError) {
      const v2Params = {
        ...offerParams,
        hotelIds
        // v2 uses array instead of comma-separated string
      };
      const hotelOffersV2 = await amadeus.get("/v2/shopping/hotel-offers", v2Params);
      return formatHotelResults(hotelOffersV2.data, params);
    }
  } catch (error) {
...
// .wrangler/tmp/bundle-tCrCj2/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-tCrCj2/middleware-loader.entry.ts
